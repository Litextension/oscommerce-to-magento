...
=== osCommerce to Magento 1.x Migration Tool ===
Version: 2.4.1
Developed by: LitExtension

Download: https://litextension.com/shopping-cart-migration/oscommerce-to-magento.html

== Description: osCommerce to Magento 1.x Migration Tool allows you to migrate your products, orders, customers, passwords and other data from osCommerce to Magento 1.x automatically.
